...
def create_empty_planning_blocks(buffer, selected_subjects, decisions=None, curriculum_buffer=None, selected_cleis=None, selected_themes=None):
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if not selected:
                ...
                updated_buffer, created, already_exists = create_empty_planning_blocks(buffer, selected, selected_cleis=selected_cleis, selected_themes=selected_themes)
                if created:
