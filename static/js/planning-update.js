(() => {
  ...
  const syncSubject = (subjectCard) => {
    ...
    const controls = subjectCard.querySelectorAll("[data-clei-check], [data-topic-select]");
  ...
  form.addEventListener("submit", (event) => {
    ...
    if (missingTopic) {
      event.preventDefault();
      window.alert("Cada CLEI marcado debe tener un tema seleccionado de la malla curricular.");
    }
  });
})();
